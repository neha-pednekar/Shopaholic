...
<figure class="individualPic">
  ...
  <img src="images/baby_girl1.jpg" alt="Iced Coffee" width="225" height="168">
  </figure>
</div>
  
  <div class="col-md-6">
    <div style="margin-top: 150px; ">
  <strong><label>FRILLY DRESST</label></strong><br>
    <form class="myform_toaddtoCart" action="men_knitwear2.php" method="post">

  <label class="price"><b>Price: 25</b></label><br>
  <b><label>Size:</label></b>
  <select name="Choose your size">
  	 
     <option value="3-6 months" selected>3-6 months (26.8 INCHES)</option>
     <option value="6-9 months">6-9 months (29.1 INCHES)</option>
     <option value="9-12 months">9-12 months (31.5 INCHES)</option>
     <option value="12-18 months">12-18 months (33.9 INCHES)</option>
     <option value="18-24 months">18-24 months (36.2 INCHES)</option>
     <option value="2-3 years">2-3 years (38.6 INCHES)</option>
     <option value="3-4 years">3-4 years (40.9 INCHES)</option>
     
    </select> <br>
    <b><label>Quantity:</label></b>
    <select name="Choose quantity">
...
<?php
      if(isset($_POST['add_but']))
      {
        ...
        $quantity = $_POST['Quantity'];
          ...
          $sql= "select prdquantity,productname from productList where prd_ID='03'";
      ...
      if($result->num_rows>0)
      {
        while($row= $result->fetch_assoc())
        {
          //update the prdList table
                  ...
                  $updatequery= "UPDATE productList set prdquantity =$newquantity where prd_ID=03 ";
                  $con->query($updatequery);
          //Add a new entry to the CartList Table
                  //product Name
                  //total Price
                  $totalPriceForPrd = $quantity*25;
                  //$query = "insert into credentials values('$username','$password')";
                  $sql_cart= "select prdQuantity from cartlist where prdID='3'";
      ...
      if($result_cart->num_rows>0)
      {
        ...
        $updatequery_cart ="UPDATE cartlist set prdQuantity =$newquantity_cart , prdTotalProce =$totalPriceForPrd_cart where prdID=3";
      ...
      {
         $insertquery ="insert into cartlist values ('3','$productName','25','$quantity','$totalPriceForPrd')";
...
<div id="myCarousel" class="carousel slide bg-inverse ml-auto mr-auto" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="carousel-item active">
      <img class="d-block w-100" src="images/baby_girl1a.jpg" alt="Fall Jacket" style="width:100%; height: 1000px">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="images/baby_girl1b.jpg" alt="Gown" style="width:100%; height: 1000px">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="images/baby_girl1c.jpg" alt="suit" style="width:100%; height: 1000px">
    </div>
