...
<head>
  ...
  <link rel="stylesheet" href="header.css">
   ...
   <link rel="stylesheet" href="assets/css/Footer-with-button-logo.css">
    <link rel="stylesheet"a href="http://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.6.3/css/font-awesome.min.css">
...
<figure class="individualPic">
  ...
  <img src="images/men_knitwear2.jpg" alt="MID RISE JEANS WITH PEARL BEADS" width="225" height="168">
  </figure>
</div>
  
  <div class="col-md-6">
    <div style="margin-top: 150px; ">
  <strong><label>VISCOSE SWEATER</label></strong><br>
  <form class="myform_toaddtoCart" action="men_knitwear2.php" method="post">
  <label class="price"><b>Price : 30</b></label><br>
...
<?php
      if(isset($_POST['add_but']))
      {
        ...
        $quantity = $_POST['Quantity'];
          ...
          $sql= "select prdquantity,productname from productList where prd_ID='02'";
      ...
      if($result->num_rows>0)
      {
        while($row= $result->fetch_assoc())
        {
          //update the prdList table
                  ...
                  $updatequery= "UPDATE productList set prdquantity =$newquantity where prd_ID=02 ";
                  $con->query($updatequery);
          //Add a new entry to the CartList Table
                  //product Name
                  //total Price
                  $totalPriceForPrd = $quantity*30;
                  //$query = "insert into credentials values('$username','$password')";
                  $sql_cart= "select prdQuantity from cartlist where prdID='2'";
      ...
      if($result_cart->num_rows>0)
      {
        ...
        $updatequery_cart ="UPDATE cartlist set prdQuantity =$newquantity_cart , prdTotalProce =$totalPriceForPrd_cart where prdID=2";
      ...
      {
         $insertquery ="insert into cartlist values ('2','$productName','30','$quantity','$totalPriceForPrd')";
...
<div id="myCarousel" class="carousel slide bg-inverse ml-auto mr-auto" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="carousel-item active">
      <img class="d-block w-100" src="images/men_knitwear2a.jpg" alt="Fall Jacket" style="width:100%; height: 1000px">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="images/men_knitwear2b.jpg" alt="Gown" style="width:100%; height: 1000px">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="images/men_knitwear2c.jpg" alt="suit" style="width:100%; height: 1000px">
    </div>
